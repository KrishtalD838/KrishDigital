        ...
        <div className="max-w-5xl mx-auto px-6 py-20 md:py-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {services.map((service) => (
              <div
                key={service.title}
                className="bg-white rounded-xl border border-gray-100 p-6 hover:shadow-sm hover:border-brand-200 transition-all"
              >
      ...
      <section className="bg-brand-50/40 border-t border-gray-100">
        <div className="max-w-5xl mx-auto px-6 py-20 md:py-28">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {approach.map((item) => (
              <div key={item.title} className="flex gap-4 p-5 rounded-xl bg-white border border-gray-100 hover:border-brand-200 transition-colors">
